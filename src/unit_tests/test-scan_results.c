...
//{
//  test_block = memblock_initialize(TEST_H_PROCESS, &test_mem_basic_info);
...
////
////  res = memblock_search(current_block, value, value_size);
////  mu_assert("Unit Test Error: memblock search failed", memblock_initialize(&procInfo, "test_application") == 0);
//  return 0;
//}
//
