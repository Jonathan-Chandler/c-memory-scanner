...
//
//  if ((retval = memscan_initialize(&procInfo, window_title)) != 0)
//    return retval;
//
...
////        }
//
//        if ((retval = memscan_create(procInfo)) != 0)
//          return retval;
//        break;
//
//      case CLI_FILTER:
...
//          return retval;
//
//        if ((retval = memscan_update(procInfo)) != 0)
//          return retval;
//        
//        if ((retval = memscan_search(procInfo, value, size)) != 0)
//          return retval;
//        break;
//
//      case CLI_PRINT:
