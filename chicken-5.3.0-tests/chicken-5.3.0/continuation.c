...
static C_char C_TLS li6[] C_aligned={C_lihdr(0,0,6),40,97,50,55,48,41,0,0};
...
a=C_alloc(12);
t2=C_mutate((C_word*)lf[2]+1 /* (set! chicken.continuation#continuation-capture ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_213,a[2]=((C_word)li0),tmp=(C_word)a,a+=3,tmp));
t3=C_mutate((C_word*)lf[4]+1 /* (set! chicken.continuation#continuation? ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_223,a[2]=((C_word)li1),tmp=(C_word)a,a+=3,tmp));
t4=C_mutate((C_word*)lf[5]+1 /* (set! chicken.continuation#continuation-graft ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_229,a[2]=((C_word)li4),tmp=(C_word)a,a+=3,tmp));
t5=C_mutate((C_word*)lf[8]+1 /* (set! chicken.continuation#continuation-return ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_262,a[2]=((C_word)li7),tmp=(C_word)a,a+=3,tmp));
t6=((C_word*)t0)[2];{
C_word *av2=av;
av2[0]=t6;
...
/* chicken.continuation#continuation-capture in k209 */
...
/* chicken.continuation#continuation? in k209 */
...
C_save_and_reclaim((void *)f_223,c,av);}
t3=t1;{
C_word *av2=av;
av2[0]=t3;
...
/* chicken.continuation#continuation-graft in k209 */
...
C_save_and_reclaim((void *)f_229,c,av);}
a=C_alloc(8);
t4=C_i_check_structure_2(t2,lf[0],lf[6]);
t5=C_slot(t2,C_fix(2));
t6=(*a=C_CLOSURE_TYPE|4,a[1]=(C_word)f_239,a[2]=t1,a[3]=t2,a[4]=t3,tmp=(C_word)a,a+=5,tmp);
...
/* k237 in chicken.continuation#continuation-graft in k209 */
...
/* chicken.continuation#continuation-return in k209 */
...
C_save_and_reclaim((void*)f_262,c,av);}
...
t6=(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_271,a[2]=t3,a[3]=((C_word)li6),tmp=(C_word)a,a+=4,tmp);
...
/* a270 in chicken.continuation#continuation-return in k209 */
...
t4=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_211,a[2]=t1,tmp=(C_word)a,a+=3,tmp);{
C_word *av2=av;
...
{C_text("f_211:continuation_2escm"),(void*)f_211},
{C_text("f_213:continuation_2escm"),(void*)f_213},
{C_text("f_223:continuation_2escm"),(void*)f_223},
{C_text("f_229:continuation_2escm"),(void*)f_229},
{C_text("f_239:continuation_2escm"),(void*)f_239},
{C_text("f_262:continuation_2escm"),(void*)f_262},
{C_text("f_271:continuation_2escm"),(void*)f_271},
