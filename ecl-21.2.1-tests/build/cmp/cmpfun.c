...
#include "C:/work/c/memscan-dll/lisp/ecl-21.2.1/build/cmp/cmpfun.eclh"
...
#include "C:/work/c/memscan-dll/lisp/ecl-21.2.1/build/cmp/cmpfun.data"
#ifdef __cplusplus
extern "C"
#endif
ECL_DLLEXPORT void _eclJoSVCkb7_RyRmqq51(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclJoSVCkb7_RyRmqq51@";
