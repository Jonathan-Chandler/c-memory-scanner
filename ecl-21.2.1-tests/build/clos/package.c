...
#include "C:/work/c/memscan-dll/lisp/ecl-21.2.1/build/clos/package.eclh"

#include "C:/work/c/memscan-dll/lisp/ecl-21.2.1/build/clos/package.data"
#ifdef __cplusplus
extern "C"
#endif
ECL_DLLEXPORT void _eclMmxSxIb7_V8Emqq51(cl_object flag)
{
 ...
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclMmxSxIb7_V8Emqq51@";
