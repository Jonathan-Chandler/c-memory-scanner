...
(si::pathname-translations "SRC" `(("**;*.*.*" "C:/work/c/memscan-dll/lisp/ecl-21.2.1/src/**/*.*")))
(si::pathname-translations "EXT" `(("**;*.*.*" "C:/work/c/memscan-dll/lisp/ecl-21.2.1/src/../contrib/**/*.*")))
(si::pathname-translations "BUILD" `(("**;*.*.*" "C:/work/c/memscan-dll/lisp/ecl-21.2.1/build/**/*.*")))
...
;;;
(si::pathname-translations "TMP" '(("**;*.*.*" "C:/work/c/memscan-dll/lisp/ecl-21.2.1/build/**/*.*")))
...
(let ((commit-id (probe-file "C:/work/c/memscan-dll/lisp/ecl-21.2.1/src/../.git/logs/HEAD")))
  (when commit-id
    (let ((last nil))
