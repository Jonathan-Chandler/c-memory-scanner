...
#include "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/cmp/cmppackage.eclh"

#include "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/cmp/cmppackage.data"
#ifdef __cplusplus
extern "C"
#endif
ECL_DLLEXPORT void _eclnNqhv7a7_7ZlZTr51(cl_object flag)
{
 ...
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclnNqhv7a7_7ZlZTr51@";
