...
#include "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/cmp/cmppolicy.eclh"
...
L4:;
   {
    ...
    v3 = ecl_make_integer((v2level)+1);
    {
     ...
     v4 = ECL_FIXNUMP(v3);
     if (ecl_unlikely(!(v4)))
         FEwrong_type_argument(ECL_SYM("FIXNUM",374),v3);
     value0 = ECL_NIL;
...
L15:;
      ...
      ecl_function_dispatch(cl_env_copy,VV[57])(2, VV[6], v6x) /*  CMPWARN */;
      goto L11;
L36:;
      T0 = ecl_car(v7flags);
...
static cl_object L7default_policy()
{
 ...
 {
TTL:
  T0 = cl_list(2, ECL_SYM("SPACE",790), ecl_symbol_value(VV[8]));
  T1 = cl_list(2, ECL_SYM("SAFETY",736), ecl_symbol_value(VV[9]));
  T2 = cl_list(2, ECL_SYM("DEBUG",272), ecl_symbol_value(VV[10]));
  T3 = cl_list(2, ECL_SYM("SPEED",793), ecl_symbol_value(VV[11]));
...
static cl_object L8cmp_env_policy(cl_object v1env)
{
 ...
 {
TTL:
  T0 = ecl_function_dispatch(cl_env_copy,VV[60])(2, VV[13], v1env) /*  CMP-ENV-SEARCH-DECLARATION */;
  value0 = ecl_car(T0);
...
static cl_object L9cmp_env_add_optimizations(cl_narg narg, cl_object v1decl, ...)
{
 ...
 if (ecl_unlikely(narg>2)) FEwrong_num_arguments_anonym();
 {
  ...
  va_end(args);
  {
   ...
   T0 = ecl_list1(v4new);
   value0 = ecl_function_dispatch(cl_env_copy,VV[62])(3, VV[13], T0, v2env) /*  CMP-ENV-ADD-DECLARATION */;
   return value0;
  }
 }
}
...
static cl_object L12add_default_optimizations(cl_object v1env)
{
 ...
 {
TTL:
  if (Null(ecl_function_dispatch(cl_env_copy,VV[60])(2, VV[13], v1env) /*  CMP-ENV-SEARCH-DECLARATION */)) { goto L1; }
  value0 = v1env;
  cl_env_copy->nvalues = 1;
  return value0;
L1:;
  T0 = L7default_policy();
  T1 = ecl_list1(T0);
  value0 = ecl_function_dispatch(cl_env_copy,VV[62])(3, VV[13], T1, v1env) /*  CMP-ENV-ADD-DECLARATION */;
  return value0;
 }
}
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L28policy_inline_bit_operations(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L29policy_open_code_aref_aset(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L30policy_evaluate_forms(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 ...
 if (ecl_unlikely(narg>1)) FEwrong_num_arguments_anonym();
 {
  ...
  va_end(args);
  {
   cl_object v2bits;
   v2bits = L8cmp_env_policy(v1env);
   value0 = cl_logtest(v2bits, VV[37]);
   return value0;
  }
 }
}
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L31policy_use_direct_c_call(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 ...
 if (ecl_unlikely(narg>1)) FEwrong_num_arguments_anonym();
 {
  ...
  va_end(args);
  {
   cl_object v2bits;
   v2bits = L8cmp_env_policy(v1env);
   value0 = cl_logtest(v2bits, VV[39]);
   return value0;
  }
 }
}
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L32policy_inline_type_checks(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 ...
 if (ecl_unlikely(narg>1)) FEwrong_num_arguments_anonym();
 {
  ...
  va_end(args);
  {
   cl_object v2bits;
   v2bits = L8cmp_env_policy(v1env);
   value0 = cl_logtest(v2bits, VV[41]);
   return value0;
  }
 }
}
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L33policy_inline_sequence_functions(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 ...
 if (ecl_unlikely(narg>1)) FEwrong_num_arguments_anonym();
 {
  ...
  va_end(args);
  {
   cl_object v2bits;
   v2bits = L8cmp_env_policy(v1env);
   value0 = cl_logtest(v2bits, VV[43]);
   return value0;
  }
 }
}
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L34policy_debug_variable_bindings(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 ...
 if (ecl_unlikely(narg>1)) FEwrong_num_arguments_anonym();
 {
  ...
  va_end(args);
  {
   cl_object v2bits;
   v2bits = L8cmp_env_policy(v1env);
   if (Null(cl_logtest(v2bits, VV[45]))) { goto L4; }
   value0 = L35policy_debug_ihs_frame(1, v1env);
   return value0;
L4:;
   value0 = ECL_NIL;
   cl_env_copy->nvalues = 1;
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L35policy_debug_ihs_frame(cl_narg narg, ...)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 ...
 if (ecl_unlikely(narg>1)) FEwrong_num_arguments_anonym();
 {
  ...
  va_end(args);
  {
   cl_object v2bits;
   v2bits = L8cmp_env_policy(v1env);
   value0 = cl_logtest(v2bits, VV[47]);
   return value0;
  }
 }
}
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L36safe_compile()
{
 cl_object T0;
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 ...
 {
TTL:
  T0 = L14cmp_env_optimization(1, ECL_SYM("SAFETY",736));
...
/*      optimize speed 1, debug 1, space 1, safety 2                  */
static cl_object L37compiler_push_events()
{
 cl_object T0;
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
#include "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/cmp/cmppolicy.data"
#ifdef __cplusplus
extern "C"
#endif
ECL_DLLEXPORT void _eclNLhXwVa7_qQqZTr51(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclNLhXwVa7_qQqZTr51@";
 VVtemp = Cblock->cblock.temp_data;
 ECL_DEFINE_SETF_FUNCTIONS
  si_select_package(VVtemp[0]);
  ecl_cmp_defun(VV[51]);                          /*  POLICY-TO-DEBUG-LEVEL */
  ecl_cmp_defun(VV[52]);                          /*  POLICY-TO-SAFETY-LEVEL */
  ecl_cmp_defun(VV[53]);                          /*  POLICY-TO-SPEED-LEVEL */
  ecl_cmp_defun(VV[54]);                          /*  POLICY-TO-SPACE-LEVEL */
  ecl_cmp_defun(VV[55]);                          /*  OPTIMIZATION-QUALITY-SWITCHES */
  ecl_cmp_defun(VV[56]);                          /*  COMPUTE-POLICY  */
  ecl_cmp_defun(VV[58]);                          /*  DEFAULT-POLICY  */
  ecl_cmp_defun(VV[59]);                          /*  CMP-ENV-POLICY  */
  ecl_cmp_defun(VV[61]);                          /*  CMP-ENV-ADD-OPTIMIZATIONS */
  ecl_cmp_defun(VV[63]);                          /*  POLICY-DECLARATION-NAME-P */
  ecl_cmp_defun(VV[64]);                          /*  MAYBE-ADD-POLICY */
  ecl_cmp_defun(VV[65]);                          /*  ADD-DEFAULT-OPTIMIZATIONS */
  ecl_cmp_defun(VV[66]);                          /*  CMP-ENV-ALL-OPTIMIZATIONS */
  ecl_cmp_defun(VV[67]);                          /*  CMP-ENV-OPTIMIZATION */
  ecl_cmp_defun(VV[68]);                          /*  POLICY-ASSUME-NO-ERRORS */
  ecl_cmp_defun(VV[69]);                          /*  POLICY-ASSUME-RIGHT-TYPE */
  ecl_cmp_defun(VV[70]);                          /*  POLICY-TYPE-ASSERTIONS */
  ecl_cmp_defun(VV[71]);                          /*  POLICY-CHECK-STACK-OVERFLOW */
  ecl_cmp_defun(VV[72]);                          /*  POLICY-CHECK-ARGUMENTS-TYPE */
  ecl_cmp_defun(VV[73]);                          /*  POLICY-ARRAY-BOUNDS-CHECK */
  ecl_cmp_defun(VV[74]);                          /*  POLICY-GLOBAL-VAR-CHECKING */
  ecl_cmp_defun(VV[75]);                          /*  POLICY-GLOBAL-FUNCTION-CHECKING */
  ecl_cmp_defun(VV[76]);                          /*  POLICY-CHECK-NARGS */
  ecl_cmp_defun(VV[77]);                          /*  POLICY-THE-IS-CHECKED */
  ecl_cmp_defun(VV[78]);                          /*  POLICY-ASSUME-TYPES-DONT-CHANGE */
  ecl_cmp_defun(VV[79]);                          /*  POLICY-INLINE-SLOT-ACCESS */
  ecl_cmp_defun(VV[80]);                          /*  POLICY-INLINE-ACCESSORS */
  ecl_cmp_defun(VV[81]);                          /*  POLICY-INLINE-BIT-OPERATIONS */
  ecl_cmp_defun(VV[82]);                          /*  POLICY-OPEN-CODE-AREF/ASET */
  ecl_cmp_defun(VV[83]);                          /*  POLICY-EVALUATE-FORMS */
  ecl_cmp_defun(VV[84]);                          /*  POLICY-USE-DIRECT-C-CALL */
  ecl_cmp_defun(VV[85]);                          /*  POLICY-INLINE-TYPE-CHECKS */
  ecl_cmp_defun(VV[86]);                          /*  POLICY-INLINE-SEQUENCE-FUNCTIONS */
  ecl_cmp_defun(VV[87]);                          /*  POLICY-DEBUG-VARIABLE-BINDINGS */
  ecl_cmp_defun(VV[88]);                          /*  POLICY-DEBUG-IHS-FRAME */
  ecl_cmp_defun(VV[89]);                          /*  SAFE-COMPILE    */
  ecl_cmp_defun(VV[90]);                          /*  COMPILER-PUSH-EVENTS */
 {
  cl_object T0;
  cl_object volatile env0 = ECL_NIL;
  si_Xmake_special(VV[4]);
  T0 = cl_make_hash_table(8, ECL_SYM("SIZE",1335), ecl_make_fixnum(64), ECL_SYM("REHASH-SIZE",1324), _ecl_static_0, ECL_SYM("REHASH-THRESHOLD",1325), _ecl_static_1, ECL_SYM("TEST",1343), ECL_SYM("EQ",335));
