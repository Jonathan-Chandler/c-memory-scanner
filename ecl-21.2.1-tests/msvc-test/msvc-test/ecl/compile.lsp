...
(progn
  ...
  (load "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/doc/help.lsp")
  (si::dump-documentation "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/help.doc"))
...
;;;
(setq c::*cc-flags*
      #-msvc "    -g -O2  -D_THREAD_SAFE -Dmingw32 -I\"C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c\""
      #+msvc "-g -O2  -D_THREAD_SAFE -Dmingw32"
      c::*ecl-include-directory* "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/"
      c::*ecl-library-directory* "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/")
#-:wants-dlopen 
(setf c::*ld-flags*
...
(let* ((c::*cc-flags* (concatenate 'string "-DECL_API -I\"C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/c\" " c::*cc-flags*))
...
(let* ((c::*ld-shared-flags* #-msvc "-Wl,--stack,1048576      -leclatomic -leclffi -leclgc   -lgmp    -lws2_32"
       ...
       (c::*cc-flags* (concatenate 'string "-DECL_API -IC:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/c " c::*cc-flags*))
       (extra-args nil))
  #+(or mingw32 cygwin)
  (progn
...
(si::pathname-translations "SYS" '(("**;*.*.*" "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/**/*.*")))
