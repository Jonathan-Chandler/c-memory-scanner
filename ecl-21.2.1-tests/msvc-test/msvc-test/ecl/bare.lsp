...
(si::pathname-translations "SRC" `(("**;*.*.*" "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/**/*.*")))
(si::pathname-translations "EXT" `(("**;*.*.*" "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/../contrib/**/*.*")))
(si::pathname-translations "BUILD" `(("**;*.*.*" "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/**/*.*")))
...
;;;
(si::pathname-translations "TMP" '(("**;*.*.*" "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/build/**/*.*")))
...
(let ((commit-id (probe-file "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/../.git/logs/HEAD")))
  (when commit-id
    (let ((last nil))
