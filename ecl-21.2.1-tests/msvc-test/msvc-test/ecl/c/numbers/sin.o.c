#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/sin.d"
...
MATH_DEF_DISPATCH1(sin, ecl_make_fixnum(/*SIN*/779), ecl_make_fixnum(/*NUMBER*/608),
