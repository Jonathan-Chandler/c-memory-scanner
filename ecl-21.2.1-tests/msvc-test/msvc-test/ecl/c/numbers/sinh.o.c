#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/sinh.d"
...
MATH_DEF_DISPATCH1(sinh, ecl_make_fixnum(/*SINH*/783), ecl_make_fixnum(/*NUMBER*/608),
