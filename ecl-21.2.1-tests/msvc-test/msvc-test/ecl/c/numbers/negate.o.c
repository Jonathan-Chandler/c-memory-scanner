#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/negate.d"
...
MATH_DEF_DISPATCH1_NE(negate, ecl_make_fixnum(/*-*/19), ecl_make_fixnum(/*NUMBER*/608),
