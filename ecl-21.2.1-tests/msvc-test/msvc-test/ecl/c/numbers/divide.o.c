#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/divide.d"
...
#line 21
cl_object cl_N(cl_narg narg, cl_object num, ...)
{
#line 21
...
#line 23
	if (ecl_unlikely(narg < 1)) FEwrong_num_arguments(ecl_make_fixnum(23));
#line 23
  /* INV: type check is in ecl_divide() */
  if (narg == 0)
  FEwrong_num_arguments(ecl_make_fixnum(/*/*/23));
  if (narg == 1) {
    {
#line 27
	#line 27
...
#endif
      CASE_UNKNOWN(ecl_make_fixnum(/*/*/23),x,y,ecl_make_fixnum(/*NUMBER*/608));
    }
  MATH_DISPATCH2_END;
