#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/minus.d"
...
#line 24
	if (ecl_unlikely(narg < 1)) FEwrong_num_arguments(ecl_make_fixnum(19));
#line 24
...
#endif
      CASE_UNKNOWN(ecl_make_fixnum(/*-*/19),x,y,ecl_make_fixnum(/*NUMBER*/608));
    }
  MATH_DISPATCH2_END;
