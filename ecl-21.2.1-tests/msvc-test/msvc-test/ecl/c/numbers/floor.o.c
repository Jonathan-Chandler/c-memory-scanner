#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/floor.d"
/* -*- Mode: C; c-basic-offset: 2; indent-tabs-mode: nil -*- */
/* vim: set filetype=c tabstop=2 shiftwidth=2 expandtab: */

/*
 * ecfloor.d - implementation of CL:FLOOR
 *
...
#line 28
	...
	va_start(ARGS, x);
#line 28
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(386));
#line 28
	if (narg > 1) {
#line 28
...
ecl_floor1(cl_object x)
{
  ...
  default:
    FEwrong_type_nth_arg(ecl_make_fixnum(/*FLOOR*/386),1,x,ecl_make_fixnum(/*REAL*/705));
  }
  ...
  MATH_DISPATCH2_BEGIN(x,y)
    ...
    default: DISPATCH2_ERROR: {
      if (!ecl_realp(x))
        ...
        FEwrong_type_nth_arg(ecl_make_fixnum(/*FLOOR*/386), 2, y, ecl_make_fixnum(/*REAL*/705));
    }
    }
  MATH_DISPATCH2_END;
