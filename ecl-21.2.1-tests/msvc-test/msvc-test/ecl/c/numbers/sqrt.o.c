#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/sqrt.d"
...
MATH_DEF_DISPATCH1(sqrt, ecl_make_fixnum(/*SQRT*/794), ecl_make_fixnum(/*NUMBER*/608),
