#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/abs.d"
...
MATH_DEF_DISPATCH1_NE(abs, ecl_make_fixnum(/*ABS*/80), ecl_make_fixnum(/*NUMBER*/608),
