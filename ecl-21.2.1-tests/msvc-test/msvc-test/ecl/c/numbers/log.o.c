#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/log.d"
...
MATH_DEF_DISPATCH1(log1, ecl_make_fixnum(/*LOG*/493), ecl_make_fixnum(/*NUMBER*/608),
...
#line 197
	...
	va_start(ARGS, x);
#line 197
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(493));
#line 197
	if (narg > 1) {
#line 197
...
#line 201
	#line 201
	cl_object __value0 = ecl_log2(y, x);
#line 201
	the_env->nvalues = 1;
#line 201
	the_env->values[0] = __value0;
...
#line 207
	#line 207
	cl_object __value0 = ecl_log1p(x);
#line 207
	the_env->nvalues = 1;
#line 207
	the_env->values[0] = __value0;
...
MATH_DEF_DISPATCH1(log1p, ecl_make_fixnum(/*SI::LOG1P*/1710), ecl_make_fixnum(/*NUMBER*/608),
