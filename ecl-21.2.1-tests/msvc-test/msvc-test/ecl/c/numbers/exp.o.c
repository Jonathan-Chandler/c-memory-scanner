#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/exp.d"
...
MATH_DEF_DISPATCH1(exp, ecl_make_fixnum(/*EXP*/345), ecl_make_fixnum(/*NUMBER*/608),
