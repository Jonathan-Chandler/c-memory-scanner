#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/numbers/round.d"
...
#line 30
	...
	va_start(ARGS, x);
#line 30
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(732));
#line 30
	if (narg > 1) {
#line 30
...
ecl_round1(cl_object x)
{
  ...
  default:
    FEwrong_type_nth_arg(ecl_make_fixnum(/*ROUND*/732),1,x,ecl_make_fixnum(/*REAL*/705));
  }
