#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/printer/integer_to_string.d"
...
bignum_to_string(cl_object buffer, cl_object x, cl_object base)
{
        ...
        if (!ECL_FIXNUMP(base) || ((b = ecl_fixnum(base)) < 2) || (b > 36)) {
                FEwrong_type_nth_arg(ecl_make_fixnum(/*SI::INTEGER-TO-STRING*/1891), 3, base,
                                     cl_list(3, ECL_SYM("INTEGER",439), ecl_make_fixnum(2),
                                             ecl_make_fixnum(36)));
        }
...
#line 81
        ...
        default:
                FEwrong_type_nth_arg(ecl_make_fixnum(/*SI::INTEGER-TO-STRING*/1891), 2,
                                     ECL_SYM("INTEGER",439), integer);
        }
}
