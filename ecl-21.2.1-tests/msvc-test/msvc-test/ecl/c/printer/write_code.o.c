#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/printer/write_code.d"
...
_ecl_write_bytecodes_readably(cl_object x, cl_object stream, cl_object lex)
{
  ...
  for (; !Null(lex); lex = ECL_CONS_CDR(lex)) {
    ...
    if (!ECL_CONSP(record) || (ECL_CONS_CAR(record) != ECL_SYM("SI::MACRO",1105) &&
                               ECL_CONS_CAR(record) != ECL_SYM("SI::SYMBOL-MACRO",1175)))
      break;
  }
