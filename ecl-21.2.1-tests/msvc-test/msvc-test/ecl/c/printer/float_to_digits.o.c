#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/printer/float_to_digits.d"
                   ...
                   cl_object relativep)
{
  ...
  k = scale(approx);
  if (Null(digits))
    digits = si_make_vector(ECL_SYM("BASE-CHAR",122), ecl_make_fixnum(10),
                            ECL_T /* adjustable */,
