#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/reader/parse_number.d"
...
infinity(cl_index exp_char, int sign)
{
  ...
  case 'f':  case 'F':
    var = (sign<0)?
      ECL_SYM("EXT::SINGLE-FLOAT-NEGATIVE-INFINITY",1768) :
      ECL_SYM("EXT::SINGLE-FLOAT-POSITIVE-INFINITY",1764);
      break;
  case 'd':  case 'D':
    var = (sign<0)?
      ECL_SYM("EXT::DOUBLE-FLOAT-NEGATIVE-INFINITY",1769) :
          ECL_SYM("EXT::DOUBLE-FLOAT-POSITIVE-INFINITY",1765);
          break;
  case 'l':  case 'L':
    var = (sign<0)?
      ECL_SYM("EXT::LONG-FLOAT-NEGATIVE-INFINITY",1770) :
          ECL_SYM("EXT::LONG-FLOAT-POSITIVE-INFINITY",1766);
          break;
#endif /* ECL_IEEE_FP */
  default:
    return OBJNULL;
