#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/cmpaux.d"
...
#line 22
	#line 22
	cl_object __value0 = ((ecl_symbol_type(sym) & ecl_stp_special)? ECL_T : ECL_NIL);
#line 22
	the_env->nvalues = 1;
#line 22
             ...
             bool allow_other_keys)     /* whether other key are allowed */
{
  ...
  for (; args[0].narg > 1; ) {
    ...
    if (keyword == ECL_SYM(":ALLOW-OTHER-KEYS",1219)) {
