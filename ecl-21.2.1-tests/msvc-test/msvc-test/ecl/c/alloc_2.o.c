#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/alloc_2.d"
...
out_of_memory(size_t requested_bytes)
{
  ...
  if (interrupts)
    ecl_enable_interrupts_env(the_env);
  ecl_bds_bind(the_env, ECL_SYM("EXT::*INTERRUPTS-ENABLED*",7), ECL_NIL);
  ...
  switch (method) {
  case 0: cl_error(1, ECL_SYM("EXT::STORAGE-EXHAUSTED",1719));
    break;
  case 1: cl_cerror(2, ecl_make_constant_base_string("Extend heap size",-1),
                    ECL_SYM("EXT::STORAGE-EXHAUSTED",1719));
    break;
  case 2:
    return output;
  default:
...
si_gc_stats(cl_object enable)
{
  ...
  if (enable == ECL_NIL) {
    ...
    cl_core.gc_stats = 1;
    GC_print_stats = (enable == ECL_SYM(":FULL",1662));
  }
  {
#line 1286
	const cl_env_ptr the_env = ecl_process_env();
#line 1286
	#line 1286
	cl_object __value0 = size1;
#line 1286
	cl_object __value1 = size2;
#line 1286
	cl_object __value2 = old_status;
#line 1286
	the_env->nvalues = 3;
#line 1286
...
si_weak_pointer_value(cl_object o)
{
  ...
  if (ecl_unlikely(ecl_t_of(o) != t_weak_pointer))
    FEwrong_type_only_arg(ecl_make_fixnum(/*EXT::WEAK-POINTER-VALUE*/1792), o,
                          ecl_make_fixnum(/*EXT::WEAK-POINTER*/1790));
