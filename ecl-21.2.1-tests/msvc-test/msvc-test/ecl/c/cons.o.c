#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/cons.d"
...
{
  if (ecl_unlikely(!ECL_LISTP(x))) FEwrong_type_nth_arg(ecl_make_fixnum(/*CAR*/182), 1, x, ecl_make_fixnum(/*LIST*/483));
  if (Null(x)) return x;
  x = ECL_CONS_CAR(x);
  return x;
}
