#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/disassembler.d"
...
disassemble_lambda(cl_object bytecodes) {
  ...
  ecl_bds_bind(env, ECL_SYM("*PRINT-PRETTY*",57), ECL_NIL);
...
disassemble(cl_object bytecodes, cl_opcode *vector) {
  ...
  if (cl_fboundp(ECL_SYM("SI::FORMATTER-AUX",1079)) != ECL_NIL)
...
#line 641
	#line 641
	cl_object __value0 = lex;
#line 641
	cl_object __value1 = vector;
#line 641
	cl_object __value2 = data;
#line 641
	cl_object __value3 = name;
#line 641
	the_env->nvalues = 4;
#line 641
...
si_bc_join(cl_object lex, cl_object code, cl_object data, cl_object name)
{
  ...
  if (lex != ECL_NIL) {
    ...
    unlikely_if (!ECL_VECTORP(code) ||
      ...
      FEwrong_type_nth_arg(ecl_make_fixnum(/*SI::BC-JOIN*/1048),
                           0, code,
                           cl_list(2,
                                   ECL_SYM("SIMPLE-ARRAY",765),
                                   ECL_SYM("EXT::BYTE8",1358)));
    }
    unlikely_if (!ECL_VECTORP(code) ||
