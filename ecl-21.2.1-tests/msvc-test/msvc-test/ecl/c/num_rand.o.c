#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/num_rand.d"
...
rando(cl_object x, cl_object rs)
{
  ...
  default: ERROR: {
    ...
    FEwrong_type_nth_arg(ecl_make_fixnum(/*RANDOM*/682),1,x, ecl_read_from_cstring(type));
  }
  }
  return z;
}
...
ecl_make_random_state(cl_object rs)
{
  ...
  if (rs == ECL_T) {
    ...
    rs = ecl_symbol_value(ECL_SYM("*RANDOM-STATE*",62));
...
#endif
  default:
    FEwrong_type_only_arg(ecl_make_fixnum(/*MAKE-RANDOM-STATE*/534), rs,
...
#line 325
	...
	va_start(ARGS, x);
#line 325
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(682));
#line 325
	if (narg > 1) {
#line 325
...
#line 325
  rs = ecl_check_cl_type(ECL_SYM("RANDOM",682), rs, t_random);
  {
#line 326
	#line 326
	cl_object __value0 = rando(x, rs);
#line 326
	the_env->nvalues = 1;
#line 326
...
#line 331
	...
	va_start(ARGS, narg);
#line 331
	if (ecl_unlikely(narg < 0|| narg > 1)) FEwrong_num_arguments(ecl_make_fixnum(534));
#line 331
	if (narg > 0) {
#line 331
		rs = va_arg(ARGS,cl_object);
...
#line 331
	#line 331
	cl_object __value0 = ecl_make_random_state(rs);
#line 331
	the_env->nvalues = 1;
#line 331
	the_env->values[0] = __value0;
...
#line 337
	#line 337
	cl_object __value0 = (ECL_RANDOM_STATE_P(x) ? ECL_T : ECL_NIL);
#line 337
	the_env->nvalues = 1;
#line 337
	the_env->values[0] = __value0;
...
si_random_state_array(cl_object rs) {
  ecl_check_cl_type(ECL_SYM("EXT::RANDOM-STATE-ARRAY",2018), rs, t_random);
