#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/serialize.d"
...
alloc(pool_t pool, cl_index size)
{
  ...
  if (next_fillp >= pool->data->vector.dim) {
    ...
    pool->data = _ecl_funcall3(ECL_SYM("ADJUST-ARRAY",85), pool->data,
...
{
  pool->data = si_make_vector(ECL_SYM("EXT::BYTE8",1358),
                              ecl_make_fixnum(1024),
                              ECL_T,
                              ecl_make_fixnum(2 * sizeof(cl_index)),
                              ECL_NIL,
                              ecl_make_fixnum(0));
  pool->hash = cl__make_hash_table(ECL_SYM("EQL",336), ecl_make_fixnum(256),
                                   cl_core.rehash_size,
...
#line 370
	#line 370
	cl_object __value0 = close_pool(pool);
#line 370
	the_env->nvalues = 1;
#line 370
...
#line 664
	#line 664
	cl_object __value0 = ecl_deserialize(data->vector.self.b8);
#line 664
	the_env->nvalues = 1;
#line 664
	the_env->values[0] = __value0;
