#line 1 "C:/work/c/memscan-dll/ecl-21.2.1-tests/ecl-rebuild/src/c/eval.d"
...
#line 143
	if (ecl_unlikely(narg < 2)) FEwrong_num_arguments(ecl_make_fixnum(91));
#line 143
{
...
#line 184
	...
	va_start(ARGS, arg);
#line 184
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(256));
#line 184
	if (narg > 1) {
#line 184
...
#line 184
  return _ecl_funcall3(ECL_SYM("EXT::CONSTANTP-INNER",2119), arg, env);
}

#line 187
cl_object si_constantp_inner(cl_narg narg, cl_object form, ...)
{
#line 187
...
#line 189
	...
	va_start(ARGS, form);
#line 189
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(2119));
#line 189
	if (narg > 1) {
#line 189
		env = va_arg(ARGS,cl_object);
...
#line 189
{
 AGAIN:
  ...
  case t_list:
    ...
    if (ECL_CONS_CAR(form) == ECL_SYM("QUOTE",681)) {
      value = ECL_T;
      break;
    }
    /*
...
#line 226
cl_object si_constant_form_value(cl_narg narg, cl_object form, ...)
{
#line 226
...
#line 228
	...
	va_start(ARGS, form);
#line 228
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(2118));
#line 228
	if (narg > 1) {
#line 228
		env = va_arg(ARGS,cl_object);
