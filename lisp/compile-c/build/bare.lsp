...
(si::pathname-translations "SRC" `(("**;*.*.*" "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/src/**/*.*")))
(si::pathname-translations "EXT" `(("**;*.*.*" "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/src/../contrib/**/*.*")))
(si::pathname-translations "BUILD" `(("**;*.*.*" "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/**/*.*")))
...
;;;
(si::pathname-translations "TMP" '(("**;*.*.*" "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/**/*.*")))
...
(let ((commit-id (probe-file "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/src/../.git/logs/HEAD")))
  (when commit-id
    (let ((last nil))
