...
#include "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/cmp/cmpopt-sequence.eclh"
...
#include "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/cmp/cmpopt-sequence.data"
#ifdef __cplusplus
extern "C"
#endif
ECL_DLLEXPORT void _eclrs5CU5b7_TNZ6lq51(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclrs5CU5b7_TNZ6lq51@";
