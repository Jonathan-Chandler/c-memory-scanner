...
(progn
  ...
  (load "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/src/doc/help.lsp")
  (si::dump-documentation "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/help.doc"))
...
;;;
(setq c::*cc-flags*
      #-msvc "    -g -O2  -D_THREAD_SAFE -Dmingw32 -I\"C:/work/lisp/ecl-21.2.1/ecl-21.2.1/src/c\""
      #+msvc "-g -O2  -D_THREAD_SAFE -Dmingw32"
      c::*ecl-include-directory* "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/"
      c::*ecl-library-directory* "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/")
#-:wants-dlopen 
(setf c::*ld-flags*
...
(let* ((c::*cc-flags* (concatenate 'string "-DECL_API -I\"C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/c\" " c::*cc-flags*))
...
(let* ((c::*ld-shared-flags* #-msvc "-Wl,--stack,1048576      -leclatomic -leclffi -leclgc   -lgmp    -lws2_32"
       ...
       (c::*cc-flags* (concatenate 'string "-DECL_API -IC:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/c " c::*cc-flags*))
       (extra-args nil))
  #+(or mingw32 cygwin)
  (progn
...
(si::pathname-translations "SYS" '(("**;*.*.*" "C:/work/lisp/ecl-21.2.1/ecl-21.2.1/build/**/*.*")))
